...
import 'package:norsk_quiz/adjectives/Listadjectives.dart';
import 'package:norsk_quiz/adjectives/RulesAdject.dart';
import 'package:norsk_quiz/customButtons.dart';
import 'package:norsk_quiz/styles.dart';
import 'dart:math';

class ThreeQ extends StatefulWidget {
  ThreeQ({Key key}) : super(key: key);
  createState() => _ThreeQState();
}

class _ThreeQState extends State<ThreeQ> {
  int seed = 0;
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        endDrawer: RulesAdject(), //DRAWER
        appBar: ExtendedAppBar('My Bokmål', '/a'),
        body: currentQuizIndex > quizes.length - 1
            ? CustomDoubleButtons('Well done!', Color(0xffC8CDE4), '/3q',
                    ...
                    children: [
                      ...
                      Wrap(
                        ...
                        children:
                          ...
                          bool currentVariantWasGuessed = guessedVariants.any(
                              (guessedVariant) => guessedVariant == variant);
                          return FittedBox(
                            fit: BoxFit.fitWidth,
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                color: Color(0xffC8CDE4).withOpacity(
                      ...
                      Column(
                          ...
                          children: quizes[currentQuizIndex]
                              .qnaMap
                              .values
                              .map((answer) {
                            ...
                            return DragTarget<String>(
                                ...
                                onWillAccept: (receivedVariant) {
                                  ...
                                  bool isVariantAlreadyDropped = filledVariants
                                      .any((filledVariant) => filledVariant
                                ...
                                builder:
                                    (context, acceptedWords, rejectedWords) =>
                                        Container(
                                          child: FittedBox(
                                            fit: BoxFit.fitWidth,
                                            child: Container(
                                              ...
                                              child: Container(
                                                child: currentAnswerWasFilled
                                                    ? ResWord(
                                                        resword: filledVariants
                                                            .firstWhere((filledVariant) =>
                                                                filledVariant
                                                                    .containsKey(
                                                                        answer))[answer],
                                                        color:
