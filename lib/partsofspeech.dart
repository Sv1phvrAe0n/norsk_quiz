...
class _NounsState extends State<Nouns> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: CustomDoubleButtons('NOUNS', Color(0xffFDCFB2), '/1q', 'Practice', '/ng', 'Grammar')
    );
  }
}
...
class _VerbsState extends State<Verbs> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        backgroundColor: Color(0xffFFFFFF),
    appBar: MinimalAppBar('My Bokmål', '/'),
      body: CustomDoubleButtons('VERBS', Color(0xffF8AD9D), '/2q', 'Practice', '/vg', 'Grammar')
    );
  }
}
...
class _AdjectivesState extends State<Adjectives> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        backgroundColor: Color(0xffFFFFFF),
        appBar: MinimalAppBar('My Bokmål', '/'),
        body: CustomDoubleButtons('ADJECTIVES', Color(0xffC8CDE4), '/3q', 'Practice', '/ag', 'Grammar')
    );
  }
}
...
class _QuestionsState extends State<Questions> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        backgroundColor: Color(0xffFFFFFF),
        appBar: MinimalAppBar('My Bokmål', '/'),
        body: CustomDoubleButtons('QUESTIONS', Color(0xffB3A6C9), '/4q', 'Practice', '/qg', 'Grammar')
    );
  }
}