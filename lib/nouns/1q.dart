...
import 'package:norsk_quiz/nouns/Listnouns.dart';
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        endDrawer: Rules(),
        appBar: ExtendedAppBar('My Bokmål', '/n'),
        body: currentQuizIndex > quizes.length - 1
            ? CustomDoubleButtons('Well done!', Color(0xffFDCFB2), '/1q',
                          ...
                          return FittedBox(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                color: Color(0xffFDCFB2).withOpacity(
