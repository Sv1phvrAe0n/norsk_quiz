                  ...
                  RichText(
                      ...
                      text: TextSpan(
                        children: [
                          ...
                          TextSpan(
                              text: 'easy patterns to form a question:',
                              style: RegularText1),
                        ],
                      )),
                  SizedBox(height: 30),
                          ...
                          child: Column(
                            ...
                            children: [
                              RichText(
                                  text: TextSpan(
                                children: [
                                  TextSpan(text: 'Hva', style: BoldRegular1),
                                  TextSpan(
                              ...
                              RichText(
                                  text: TextSpan(
                                children: [
                                  TextSpan(text: 'Hvem', style: BoldRegular1),
                              ...
                              RichText(
                                  text: TextSpan(
                                children: [
                                  TextSpan(text: 'Når', style: BoldRegular1),
                                  TextSpan(
                              ...
                              RichText(
                                  text: TextSpan(
                                children: [
                                  TextSpan(text: 'Hvor', style: BoldRegular1),
                                  TextSpan(
                        ...
                        children: [
                          ...
                          RichText(
                            ...
                            children: [
                              TextSpan(text: 'Hva slags ', style: BoldRegular1),
                              TextSpan(
                                  text: 'mat liker du?', style: RegularText1),
                              TextSpan(
                          ...
                          RichText(
                            ...
                            children: [
                              TextSpan(
                                  text: 'Hvor mange ', style: BoldRegular1),
                              TextSpan(
                                  text: 'barn har du?', style: RegularText1),
                              TextSpan(
                          ...
                          RichText(
                            ...
                            children: [
                              TextSpan(
                                  text: 'Hvor lenge ', style: BoldRegular1),
                              TextSpan(
                                  text: 'siden var det?', style: RegularText1),
                              TextSpan(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              RichText(
                                  text: TextSpan(
                                children: [
                                  TextSpan(text: 'Hvilke', style: BoldRegular1),
                                  TextSpan(
...
// mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                            children: [
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(
                                      text: 'Hvilken jente er søstera din?',
                                      style: RegularText1),
                                  TextSpan(
                        ...
                        children: [
                          RichText(
                            ...
                            children: [
                              ...
                              TextSpan(
                                  text: 'er din bok?', style: RegularText1),
                              TextSpan(
                                  text: '\nWhich is your book?',
                                  style: CursiveRegular),
                            ],
                  ...
                  Align(
                    alignment: Alignment.topLeft,
                    child: Text('4. Change the word order', style: HeaderText),
                  ),
                  SizedBox(height: 10),
                  RichText(
                      text: TextSpan(
                        ...
                        children: [
                          ...
                          RichText(
                            ...
                            children: [
                              ...
                              TextSpan(
                                  text: 'vi dra i kveld?', style: RegularText1),
                              TextSpan(
                  ...
                  RichText(
                    ...
                    children: [
                      ...
                      TextSpan(
                          text: '(roughly translated as ', style: RegularText1),
                      ...
                      child: Column(
                        ...
                        children: [
                          RichText(
                            ...
                            children: [
                              TextSpan(
                                  text: 'Maten var god, ', style: RegularText1),
                              TextSpan(text: 'ikke sant?', style: BoldRegular1),
                              TextSpan(
                          ...
                          RichText(
                            ...
                            children: [
                              TextSpan(
                                  text: 'De kan vinne, ', style: RegularText1),
                              TextSpan(text: 'ikke sant?', style: BoldRegular1),
                              TextSpan(
