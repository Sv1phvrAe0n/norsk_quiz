...
class _FourQState extends State<FourQ> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        CustomDoubleButtons('Well done!', Color(0xffB3A6C9), '/4q', 'Practice again',
            '/', 'To main menu')
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center,
              children: [
                      ...
                      Container(
                        ...
                        child: Draggable<String>(
                          ...
                          feedback: Container(
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.all(Radius.circular(10)),
                                  color: Color(0xffB3A6C9).withOpacity(currentVariantWasGuessed ? 0 : 0.5) //цвет плашки когда она несется
                              ),
                              margin: const EdgeInsets.all(6.0),
                              child:
                                    ...
                                    child: Container(
                                      child: currentAnswerWasFilled
                                        ...
                                        fontsize: 25.0,
                                          ...
                                          : ResWord(
                                        resword: answer,
                                        color: Color(0xff231A31).withOpacity(0),
                                      ),
                                    ),
                                  ),
                                ),
                ...
                Container(
                  ...
                  child: Text(' ? ', style: TextStyle(fontSize: 25.0, color: Color(0xff231A31), fontFamily: 'Comfortaa'),)
                ),
                SizedBox(height: 20),
