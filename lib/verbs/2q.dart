  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        CustomDoubleButtons('Well done!', Color(0xffF8AD9D), '/2q', 'Practice again',
            '/', 'To main menu')
                      ...
                      Container(
                        ...
                        child: Draggable<String>(
                          ...
                          feedback: Container(
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.all(Radius.circular(10)),
                                  color: Color(0xffF8AD9D).withOpacity(currentVariantWasGuessed ? 0 : 0.5) //цвет плашки когда она несется
                              ),
                              margin: const EdgeInsets.all(6.0),
                              child:
