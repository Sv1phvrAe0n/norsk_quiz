...
class VerbQ extends StatefulWidget {
  @override
  _VerbQState createState() => _VerbQState();
}

class _VerbQState extends State<VerbQ> {
  int seed = 0;
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: ExtendedAppBar('My Bokmål', '/v'),
        body: currentQuizIndex > quizes.length - 1
            ? CustomDoubleButtons('Well done!', Color(0xffF8AD9D), '/2q',
                          ...
                          return FittedBox(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                color: Color(0xffF8AD9D).withOpacity(
