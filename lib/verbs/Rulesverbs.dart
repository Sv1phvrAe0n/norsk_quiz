          ...
          child: Container(
              ...
              child: Column(
                children: [
                  ...
                  RichText(
                      ...
                      text: TextSpan(
                        children: [
                          TextSpan(
                              text:
                                  'Verbs conjugation in Norwegian is based on ',
                              style: RegularText1),
                          TextSpan(text: '3 ', style: BoldRegular1),
                          TextSpan(
                              text: 'main principles:', style: RegularText1),
                        ],
                      )),
                  SizedBox(height: 30),
                  Align(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Align(
                                alignment: Alignment.topLeft,
                                child: Text('English', style: BoldRegular1),
                              ),
                              SizedBox(height: 8.5),
                              RichText(
                                  text: TextSpan(
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(text: 'You ', style: RegularText),
                                  TextSpan(
                                      text: '(plural) ', style: CursiveRegular),
                                  TextSpan(text: 'are', style: BoldRegular),
                                ],
                              )),
                              SizedBox(height: 2),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Align(
                                alignment: Alignment.topLeft,
                                child: Text('Norsk', style: BoldRegular1),
                              ),
                              SizedBox(height: 8.5),
                              RichText(
                                  text: TextSpan(
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(
                                      text: 'Han/hun ', style: RegularText),
                                  TextSpan(text: 'er', style: BoldRegular),
                                ],
                              )),
                              SizedBox(height: 2),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(
                                      text: 'Infinitive', style: RegularText)
                                ],
                              )),
                              SizedBox(height: 2),
                              RichText(
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(
                                      text: 'Preterite', style: RegularText),
                                ],
                              )),
                              SizedBox(height: 2),
                              RichText(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(
                                      text: 'Infinitiv', style: RegularText)
                                ],
                              )),
                              SizedBox(height: 2),
                              RichText(
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(
                                      text: 'Preteritum', style: RegularText),
                                ],
                              )),
                              SizedBox(height: 2),
                              RichText(
                  ...
                  Align(
                    alignment: Alignment.topLeft,
                    child: Text('3.1. Infinitive', style: HeaderText),
                  ),
                  SizedBox(height: 10),
                  RichText(
                      text: TextSpan(children: [
                  ...
                  Card(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.5),
                        child: Text('Infinitive = stem + e / _',
                            style: BoldRegular1),
                      )),
                  SizedBox(height: 10),
                  Row(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(
                                      ...
                                      style: RegularText1),
                                  TextSpan(
                                      text: 'å studere ', style: BoldRegular1),
                                  TextSpan(
                                      text: '\nIt is easy to study',
                                      style: CursiveRegular),
                                ],
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(
                                      text: 'Jeg liker ', style: RegularText1),
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(
                                      text: 'Vi hater ', style: RegularText1),
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(
                                      text: 'Du glemte ', style: RegularText1),
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(
                                      text: 'Jeg må ', style: RegularText1),
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(
                                      text: 'Du kan ', style: RegularText1),
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(
                                      text: 'Han bør ', style: RegularText1),
                  ...
                  Align(
                    alignment: Alignment.topLeft,
                    child: Text('3.2. Present', style: HeaderText),
                  ),
                  SizedBox(height: 10),
                  RichText(
                      text: TextSpan(children: [
                  ...
                  Card(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.5),
                        child:
                            Text('Present = stem + er/r', style: BoldRegular1),
                      )),
                  SizedBox(height: 10),
                  RichText(
                      text: TextSpan(children: [
                    TextSpan(
                        text: 'Some irregular verbs don\'t follow the ',
                        style: RegularText1),
                    TextSpan(text: 'stem + er/r ', style: BoldRegular1),
                    TextSpan(
                        text: 'rule and have no ending at all: ',
                        style: RegularText1),
                    TextSpan(
                        text:
                            '\nå måtte (må), å kunne (kan), å synes (synes), å vite (vet)',
                        style: BoldRegular1),
                    TextSpan(
                            ...
                            children: [
                              ...
                              RichText(
                                  ...
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                          text: 'Regular', style: RegularText1),
                                    ],
                                  )),
                              SizedBox(height: 170),
                              RichText(
                            ...
                            children: [
                              ...
                              RichText(
                                ...
                                children: [
                                  ...
                                  TextSpan(
                                      text: 'jobber ', style: BoldRegular1),
                              ...
                              RichText(
                                ...
                                children: [
                                  ...
                                  TextSpan(
                                      text: 'skinner', style: BoldRegular1),
                                  TextSpan(
                                      text: '\nThe Sun is shining',
                                      style: CursiveRegular),
                                ],
                              ...
                              RichText(
                                ...
                                children: [
                                  ...
                                  TextSpan(
                                      text: 'to bøker', style: RegularText1),
                                  TextSpan(
                                      text: '\nI have to books',
                                      style: CursiveRegular),
                                ],
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(text: 'Har ', style: BoldRegular1),
                                  TextSpan(
                                      text: 'du tid?', style: RegularText1),
                                  TextSpan(
                                      text: '\nGot time?',
                                      style: CursiveRegular),
                                ],
                  ...
                  Align(
                    alignment: Alignment.topLeft,
                    child: Text('3.3. Preterite', style: HeaderText),
                  ),
                  SizedBox(height: 10),
                  RichText(
                      text: TextSpan(children: [
                  ...
                  Card(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.5),
                        child: Text('Preterite = stem + et/te',
                            style: BoldRegular1),
                      )),
                  SizedBox(height: 10),
                  RichText(
                            ...
                            children: [
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(text: 'Hun ', style: RegularText1),
                                  TextSpan(
                                      text: 'jobbet ', style: BoldRegular1),
                              ...
                              RichText(
                                ...
                                children: [
                                  ...
                                  TextSpan(
                                      text: 'spiste ', style: BoldRegular1),
                                  TextSpan(
                                      text: 'frokost', style: RegularText1),
                                  TextSpan(
                                      text: '\nYou ate breakfast',
                                      style: CursiveRegular),
                                ],
                  ...
                  Align(
                    alignment: Alignment.topLeft,
                    child: Text('3.4. Present perfect', style: HeaderText),
                  ),
                  SizedBox(height: 10),
                  RichText(
                      text: TextSpan(children: [
                  ...
                  Card(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.5),
                        child: Text('Present perfect = har + (stem + et/t)',
                            style: BoldRegular1),
                      )),
                  SizedBox(height: 10),
                  RichText(
                      text: TextSpan(children: [
                    TextSpan(
                        text: 'Please note that you always use ',
                        style: RegularText1),
                    TextSpan(text: 'har ', style: BoldRegular1),
                    TextSpan(text: '+ ', style: RegularText1),
                    TextSpan(text: 'main verb ', style: BoldRegular1),
                    TextSpan(
                        text: 'in Perfect form (not in Preterite form).',
                        style: RegularText1),
                  ])),
                  SizedBox(height: 10),
                  Row(
                            ...
                            children: [
                              RichText(
                                ...
                                children: [
                                  TextSpan(text: 'Jeg ', style: RegularText1),
                                  TextSpan(
                                      text: 'har kjøpt ', style: BoldRegular1),
                                  TextSpan(text: 'ei bok', style: RegularText1),
                                  TextSpan(
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(text: 'Han ', style: RegularText1),
                                  TextSpan(
                                      text: 'har sett ', style: BoldRegular1),
                              ...
                              RichText(
                                ...
                                children: [
                                  ...
                                  TextSpan(text: 'du ', style: RegularText1),
                                  TextSpan(
                                      text: 'invitert ', style: BoldRegular1),
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(text: 'Vi ', style: RegularText1),
                                  TextSpan(
                                      text: 'har besøkt ', style: BoldRegular1),
                                  TextSpan(text: 'ham', style: RegularText1),
                                  TextSpan(
                                      text: '\nWe have visited him',
                                      style: CursiveRegular),
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(text: 'Jeg ', style: RegularText1),
                                  TextSpan(
                                      text: 'har gjort ', style: BoldRegular1),
                                  TextSpan(
                                      text: 'ingenting', style: RegularText1),
                                  TextSpan(
                                      text: '\nI have done nothing',
                                      style: CursiveRegular),
                                ],
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(text: 'Han ', style: RegularText1),
                                  TextSpan(
                                      text: 'har vært ', style: BoldRegular1),
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(text: 'Vi ', style: RegularText1),
                                  TextSpan(
                                      text: 'har hatt ', style: BoldRegular1),
                                  TextSpan(
                                      text: 'det gøy!', style: RegularText1),
                                  TextSpan(
                                      text: '\nWe have had fun!',
                                      style: CursiveRegular),
                                ],
                  ...
                  RichText(
                    ...
                    TextSpan(
                        text:
                            ...
                            '\n\nThis tense is expressed in several ways: ',
                        style: RegularText1),
                    ...
                    TextSpan(
                        text:
                            ...
                            'when implying an agreement, arrangement or promise.',
                        style: RegularText1),
                  ])),
                  SizedBox(height: 10),
                  Card(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.5),
                        child: Text('Certain future = skal + infinitive',
                            style: BoldRegular1),
                      )),
                  SizedBox(height: 10),
                  Row(
                            ...
                            children: [
                              RichText(
                                ...
                                children: [
                                  TextSpan(text: 'Jeg ', style: RegularText1),
                                  TextSpan(
                                      text: 'skal dra ', style: BoldRegular1),
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(text: 'Jeg ', style: RegularText1),
                                  TextSpan(
                                      text: 'skal tenke ', style: BoldRegular1),
                              ...
                              RichText(
                                ...
                                TextSpan(
                                    text: 'skal gifte ', style: BoldRegular1),
                                TextSpan(
                                    text: 'seg neste år', style: RegularText1),
                                TextSpan(
                  ...
                  RichText(
                    ...
                    TextSpan(
                        text:
                            ...
                            'It is a very neutral way of expressing a future event.',
                        style: RegularText1),
                  ])),
                  SizedBox(height: 10),
                  Card(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.5),
                        child: Text('Uncertain future  = vil + infinitive',
                            style: BoldRegular1),
                      )),
                  SizedBox(height: 10),
                  Row(
                            ...
                            children: [
                              RichText(
                                ...
                                children: [
                                  TextSpan(text: 'Du ', style: RegularText1),
                                  TextSpan(
                                      text: 'vil bli ', style: BoldRegular1),
                                  TextSpan(
                                      text: 'høyere enn faren din',
                                      style: RegularText1),
                                  TextSpan(
                                      text:
                                          '\nYou will become taller than your dad',
                                      style: CursiveRegular),
                                ],
                              )),
                              SizedBox(height: 4),
                              RichText(
                                ...
                                children: [
                                  TextSpan(
                                      text: 'Prisene ', style: RegularText1),
                                  TextSpan(
                                      text: 'vil gå ', style: BoldRegular1),
                  ...
                  RichText(
                    ...
                    TextSpan(text: 'infinitive', style: BoldRegular1),
                    TextSpan(
                        text: '\nCan be helpful to use instead of ',
                        style: RegularText1),
                    TextSpan(text: 'vil', style: BoldRegular1),
                    TextSpan(
                        text: ', when it’s not clear if ', style: RegularText1),
                    TextSpan(text: 'vil ', style: BoldRegular1),
                            ...
                            children: [
                              RichText(
                                ...
                                children: [
                                  TextSpan(text: 'De ', style: RegularText1),
                                  TextSpan(
                                      text: 'kommer til å besøke ',
                                      style: BoldRegular1),
                                  TextSpan(text: 'Norge', style: RegularText1),
                                  TextSpan(
                                      text: '\nThey are going to visit Norway',
                                      style: CursiveRegular),
                                ],
                              )),
                              SizedBox(height: 4),
                              RichText(
                                ...
                                children: [
                                  TextSpan(text: 'Han ', style: RegularText1),
                                  TextSpan(
                                      text: 'kommer til å spise ',
                                      style: BoldRegular1),
                                  TextSpan(text: 'kake', style: RegularText1),
                                  TextSpan(
                                      text: '\nHe is going to eat cake',
                                      style: CursiveRegular),
                                ],
                              )),
                              SizedBox(height: 4),
                  ...
                  RichText(
                    ...
                    TextSpan(
                        text:
                            ...
                            'time adverbial is usually included so as not to cause confusion with a present time reference.',
                        style: RegularText1),
                  ])),
                  SizedBox(height: 10),
                  Card(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(8.5),
                        child: Text('Near future = Present simple + adverbial',
                            style: BoldRegular1),
                      )),
                  SizedBox(height: 10),
                  Row(
                            ...
                            children: [
                              RichText(
                                ...
                                children: [
                                  TextSpan(text: 'Jeg ', style: RegularText1),
                                  TextSpan(
                                      text: 'reiser ', style: BoldRegular1),
                                  TextSpan(
                                      text: 'i morgen', style: RegularText1),
                                  TextSpan(
                              ...
                              RichText(
                                ...
                                children: [
                                  TextSpan(text: 'De ', style: RegularText1),
                                  TextSpan(
                                      text: 'ankommer ', style: BoldRegular1),
